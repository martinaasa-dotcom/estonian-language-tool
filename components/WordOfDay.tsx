  ...
  return (
    <Card className={className}>
      ...
      <div className="flex flex-wrap items-center gap-2">
        <p lang="et" className="est text-3xl font-bold leading-tight" style={{ color: "var(--ink)" }}>
          {word.lemma}
        </p>
      ...
      */}
      ...
      {word.example && (
        <figure className="mt-4 rounded-[var(--r)] px-3.5 py-3" style={{ background: "var(--sky-soft)" }}>
          <blockquote lang="et" className="est text-sm leading-relaxed" style={{ color: "var(--ink)" }}>
            {word.example.et}
          </blockquote>
          {word.example.en && (
