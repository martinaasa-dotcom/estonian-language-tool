...
function OfflineBanner({ online, pending, syncing }: {
  ...
  return (
    <div
      ...
      className="bottom-notice fixed inset-x-0 z-50 flex items-center justify-center gap-2 px-4 py-2 text-[13.5px] md:left-auto md:right-3 md:inset-x-auto md:rounded-md"
      style={{
