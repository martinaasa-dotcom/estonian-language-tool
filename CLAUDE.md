...
`glossSentences`, `GlossedSentence`, `repairCaseFronts`, `unsentencedCaseCards`,
`isBareCaseFront`, `hasSentence`, `borrowSentences`, `claimIndex`, `borrowedSentences`,
`formSentencesFor`. Most of them now
