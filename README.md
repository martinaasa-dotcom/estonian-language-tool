...
npm run test       # unit tests (282) — no database needed; DB-backed tests skip themselves
npm run test:e2e   # browser checks (115) — needs the server running, and a local database
