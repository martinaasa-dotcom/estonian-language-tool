    ...
    >
      <div className="flex flex-col gap-7">
              ...
              {memberships.map((m) => (
                <li key={m.classroomId}>
                  <Link
                    ...
                    className="flex flex-wrap items-center gap-3 rounded-lg border px-4 py-3.5 transition-opacity hover:opacity-85"
        ...
        <Note tone="neutral">
          ...
          <code className="mx-1 text-[12px]">lib/classroom/roster.ts</code>.
        </Note>
      </div>
    </Page>
  );
