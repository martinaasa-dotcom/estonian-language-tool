...
/**
 * The same ceiling `searchLexemes` uses. The whole dictionary is pulled once
 * and matched in memory, which at a few thousand rows is milliseconds and
 * saves one query per word on a page that can carry sixty.
 */
