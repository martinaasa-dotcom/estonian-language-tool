 ...
 * rather than a thing to press. Four is a choice, and it is four rather than
 * three because the grid is two across: three leaves a hole in the corner.
 */
export function practiceTiles(stage: Stage): number {
  return stage === "settled" ? 6 : 4;
}
